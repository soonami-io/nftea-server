...
const app_component = {
  ...
  methods: {
    ...
    brew_tea: async function () {
      ...
      console.log(_combination.replace(/\s/g, ""));
      ...
      // this.backend_response.signature ="0x"+"6789accd0e66c7791e6b2c0d7a1166468c79f709143b2a9194d4e795b44e09e5502e28499f5ce2c38fe9ded4743c381150bf1c11f20ff9eeb4ef208d7de26b811c";
      // // this.backend_response.uri = "https://mquark.infura-ipfs.io/ipfs/QmaPvrGQWjNQNSmPt5bbK7bGMorHooxhAXZZqRMnmSmssN";
      // this.backend_response.uri = "ipfs://QmNMAb2THx2jonU4TDmTUkjXHWNSJfriB7LTn3av7vzyFo";
      // this.backend_response.salt = "0x01";
      // this.brewed_tea = "./assets/image/dalle.png";
      // window.localStorage.setItem("brewed_tea",this.brewed_tea)
    },
