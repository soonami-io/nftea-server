  ...
  methods: {
    ...
    mint_with_contributing: async function () {
      ...
      try {
        ...
        if (error.message != "MetaMask Tx Signature: User denied transaction signature.") window.alert("Sorry, there is not enough MATIC in your wallet for that contribution");
